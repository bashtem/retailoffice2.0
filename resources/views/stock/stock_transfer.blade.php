...
@section('contentWrapper')
    <div class="container-fluid size10" ng-controller="stocktransfer" >
        ...
        <ol class="breadcrumb size11 ">
            ...
            <span class="nav-link-text">Stock Transfer</span> </a>
            </li>                
        </ol>
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active text-muted" data-toggle="tab" href="#transferRequest"><i class="far fa-hand-holding-water"></i> Request Transfer </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  text-muted" data-toggle="tab" href="#transfer" ng-click="confirmTransferDatas()" ><i class="fal fa-bolt"></i> Active Transfers</a>
            </li>
        </ul><br>
        <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade show active" id="transferRequest">
                        <div class="row container text-muted">
                            ...
                            <div class="col-md-9">
                                <span><i class="fa fa-clipboard-list"></i> Transfer List</span><hr> 
                                    ...
                                    <a ng-hide="transferItems.items.length==0" href="#" class="btn btn-outline-primary btn-sm size10 float-right" ng-click="transferRequest()"><i class="far fa-hand-pointer"></i> Request Transfer  </a>
                        
                                    <div class="alert alert-secondary text-center text-muted" ng-hide="transferItems.items.length != 0">
                                        <h6 class="alert-heading">Empty Stock Transfer List </h6>
                                        <p class="mb-0">Kindly add items to transfer list.</p>
                                    </div>
                            </div>
                        </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="alert alert-secondary text-center text-muted" ng-show="transferDatas.length == 0">
                                <h6 class="alert-heading">No Active Transfers!</h6>
                                <p class="mb-0">Kindly Request for a Stock Transfer.</p>
                            </div>
