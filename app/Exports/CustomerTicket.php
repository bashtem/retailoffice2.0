...
class CustomerTicket implements FromCollection, WithHeadings, ShouldAutoSize, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    {
        $this->data = $data;
        $this->reportResult = $data['cusByTicketList'];
    ...
    {
        $this->reportResult[] = ["TOTAL", $this->data['totals']['totalTicket'], $this->data['totals']['totalQty'], $this->data['totals']['totalAmount']];
